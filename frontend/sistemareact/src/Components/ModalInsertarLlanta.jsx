                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="id_provedor" className="form-label">Proveedor</label>
                                        <select className="form-select" id="id_provedor" name="id_provedor" value={formData.id_proveedor}>
